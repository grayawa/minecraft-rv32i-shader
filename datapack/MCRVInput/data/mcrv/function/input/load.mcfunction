...
scoreboard objectives add mcrv_jump minecraft.custom:minecraft.jump
scoreboard objectives add mcrv_jump_prev dummy
scoreboard objectives add mcrv_debug dummy
